...
const DetailsProduct = ({setDetailsVisible,item}) => {
    console.log('[DetailsProduct] Rerender');
  return (
    <ScrollView >
        ...
        ,borderRadius:30,marginTop:30,}}>
            <Text style={{fontSize:18,padding:15}}>
            {item.companyOfOriginDescription}
            </Text>
        </View>
        ...
        padding:30}}>
            ...
            <Text style={{fontSize:15,fontWeight:'bold',color:'#fff'
            ,marginLeft:20}}>
            {item.quantityOrder} Of {item.quantityStock}
            </Text>
        </View>
    </ScrollView>
  );
